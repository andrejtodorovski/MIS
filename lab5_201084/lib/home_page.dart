...
import 'package:lab3_201084/google_maps.dart';
import 'package:lab3_201084/location.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  final List<Exam> _exams = [
    Exam(1, "МИС", DateTime.now(), Location.finki),
    Exam(2, "ВБС", DateTime.now().add(const Duration(days: 1)), Location.feit),
    Exam(3, "АПС", DateTime.now().add(const Duration(days: 2)), Location.feit),
    Exam(4, "ВИС", DateTime.now().add(const Duration(days: 2)), Location.tmf),
    Exam(5, "ВНП", DateTime.now(), Location.tmf),
  ];
